...
const ComicDetailPage = () => {
  ...
  useEffect(() => {
    ...
    // Fetch comic details
    axios.get(`http://localhost:8080/api/v1/comics/${id}`)
      .then(response => {
    ...
    axios.get(`http://localhost:8080/api/v1/chapters/byComic/${id}`)
      .then(response => {
  ...
  return (
    <div className="comic-detail-container">
      ...
      <Link to="/" className="back-button">Quay về Danh sách Truyện tranh</Link>
    </div>
  );
};
